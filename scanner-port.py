...
time.sleep(4)
print (f"""
{rd}[-]{yw} Creator channel Rubika: {Lgn}@tyro_code
{rd}[!]{yw}To use, please enter https and http! 
{rd}[!] Communication is TCP! 
""")
print ("")
time.sleep(2)
host = input(f"{rd} ┌─["+f"{Lgn}@tyro_code"+f"{be}/"+f"{we}port-scanner"+f"""{rd}]
...
print (f"{rd}[*]{gn} channel Rubika : {Lgn} https://rubika.ir/tyro_code")
